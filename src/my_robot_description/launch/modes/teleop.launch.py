"""Teleop mode launch file that uses the components launch files"""
...
def generate_launch_description():
    ...
    # Include the robot_description, rviz, gazebo and teleop launch files from the modular components
    ...
    teleop = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(os.path.join(include_dir, 'control.launch.py')),
        launch_arguments={'param_file': param_file}.items()
    )
